        ...
        <div class="card">
          <b-table class="table table-striped"  style="border: 1px solid darkturquoise;">
            ...
            <tr v-for="item2 in data2">
              ...
              <td style="border: 1px solid darkturquoise;">{{ item2.prevmonthCRN.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
              <td style="border: 1px solid darkturquoise;">{{ item2.prevmonthOut.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 }) }}</td>
            </tr>
            </tbody>
          </b-table>
        </div>
